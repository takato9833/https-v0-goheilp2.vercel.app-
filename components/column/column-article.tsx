...
export function ColumnArticle() {
  return (
    <article className="py-8 md:py-20">
        ...
        <div>
          ...
          <header className="mb-8 md:mb-14">
            <div className="flex items-center gap-3 mb-3">
              <span className="inline-block px-2.5 py-0.5 text-xs font-medium bg-accent/10 text-accent rounded-sm">
                遺品整理
              </span>
            </div>
            <h1 className="text-xl sm:text-3xl md:text-4xl font-bold leading-snug text-balance mb-4 md:mb-6">
            ...
            <div className="mt-6 md:mt-8 h-px w-full bg-border" />
          </header>
          ...
          <div className="space-y-8 md:space-y-12">
            ...
            {/* Section 1 */}
            <section className="space-y-3 md:space-y-4">
              <h2 className="text-lg md:text-2xl font-bold text-foreground flex items-center gap-2.5 md:gap-3">
                <span className="flex items-center justify-center h-7 w-7 md:h-8 md:w-8 rounded-full bg-accent text-accent-foreground text-xs md:text-sm font-bold shrink-0">
                  1
                </span>
                遺品整理を始めるタイミング
              </h2>
            ...
            <section className="space-y-3 md:space-y-4">
              ...
              <ul className="space-y-2 md:space-y-3 pl-2 md:pl-4">
                <li className="flex items-start gap-2.5 md:gap-3 text-sm md:text-lg leading-relaxed text-muted-foreground">
                  <span className="h-1.5 w-1.5 rounded-full bg-accent mt-2.5 md:mt-3 shrink-0" />
            ...
            <section className="space-y-3 md:space-y-4">
              ...
              <div className="bg-secondary/50 rounded-sm p-4 md:p-8 border border-border space-y-3 md:space-y-4">
                <div className="flex items-start gap-2.5 md:gap-3">
                  <span className="text-accent font-bold text-base md:text-lg shrink-0">01</span>
                  <div>
                    <p className="font-semibold text-foreground text-sm md:text-base">時間と労力の大幅削減</p>
                ...
                <div className="flex items-start gap-2.5 md:gap-3">
                  <span className="text-accent font-bold text-base md:text-lg shrink-0">02</span>
                  <div>
                    <p className="font-semibold text-foreground text-sm md:text-base">買取による費用の軽減</p>
                    <p className="text-xs md:text-base text-muted-foreground mt-1">
                ...
                <div className="h-px bg-border" />
                <div className="flex items-start gap-2.5 md:gap-3">
                  <span className="text-accent font-bold text-base md:text-lg shrink-0">03</span>
                  <div>
                    <p className="font-semibold text-foreground text-sm md:text-base">供養の手配もお任せ</p>
                    <p className="text-xs md:text-base text-muted-foreground mt-1">
            ...
            <section className="space-y-3 md:space-y-4 pt-2 md:pt-4">
              ...
              <h2 className="text-lg md:text-2xl font-bold text-foreground pt-2 md:pt-4">
                まとめ
              </h2>
              <p className="text-sm md:text-lg leading-relaxed text-muted-foreground">
